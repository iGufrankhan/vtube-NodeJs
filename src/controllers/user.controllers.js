...
const generateAccessAndRefereshTokens = async (userId) => {
    try {
        ...
        if (alreadyExists && alreadyExists._id.toString() !== userId.toString()) {
...
const registerUser=asyncHandler(async(req,res)=>
{
    ...
    if (!avatarLocalPath) {
        throw new ApiErrors(400, "All fields are required. Missing: avatar")
    }
...
try {
    ...
    throw new ApiErrors(500,"something went wrong while registation of user")
}
...
const changeCurrentPassword=asyncHandler(async(req,res)=>{
     ...
     if(!user)
     {
        throw new ApiErrors(400,"enter valid user name")
